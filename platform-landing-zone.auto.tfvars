...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "dan@dscloud.tech" //Replace this email with your security contact email
    ...
    primary_firewall_enabled                                             = false // Enable Firewall in the primary hub
    primary_firewall_management_ip_enabled                               = false // Enable Firewall Management IP configuration in the primary hub
    primary_virtual_network_gateway_express_route_enabled                = false // Enable ExpressRoute Gateway in the primary hub
    primary_virtual_network_gateway_express_route_hobo_public_ip_enabled = false // Enable ExpressRoute Gateway Hosted on Behalf Of Public IP in the primary hub
    primary_virtual_network_gateway_vpn_enabled                          = false // Enable VPN Gateway in the primary hub
    primary_private_dns_zones_enabled                                    = false // Enable Private DNS Zones 
    primary_private_dns_auto_registration_zone_enabled                   = false // Enable Private DNS Zones Auto Registration 
    primary_private_dns_resolver_enabled                                 = false // Enable Private DNS Resolver 
    primary_bastion_enabled                                              = false // Enable Bastion 
